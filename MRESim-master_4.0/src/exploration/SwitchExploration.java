...
public class SwitchExploration {
    ...
    public static Point takestep(RealAgent agent, int timeElapsed,
        ...
        if(!isMultiHopping()){
                System.err.println("doing a Frontier WITH MY ROBOT" + agent.getName());
                return FrontierExploration.takeStep(agent, timeElapsed, frontierExpType.ReturnWhenComplete, simConfig);
            }
        else{
